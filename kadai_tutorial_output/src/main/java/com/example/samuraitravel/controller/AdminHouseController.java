...
@Controller
@RequestMapping("/admin/houses")/*URLの末尾*/
public class AdminHouseController {
	...
	@GetMapping/*すでにデータベースにあるデータを検索して表示*/
	...
	@PostMapping("/create")/*Psst:画面上で作成したものを登録*/
    public String create(@ModelAttribute @Validated HouseRegisterForm houseRegisterForm, BindingResult bindingResult, RedirectAttributes redirectAttributes) {        
     ...
     public String edit(@PathVariable(name = "id") Integer id, Model model) {
         ...
         /*それぞれの値を画面に表示getid...*/
         model.addAttribute("imageName", imageName);/*画像*/
         model.addAttribute("houseEditForm", houseEditForm);/*編集画面*/
         
         return "admin/houses/edit";
     }   
	 
	 @PostMapping("/{id}/update")/*データベースの値を更新*/
